...
class MelEditTablet extends GetView<MelEditLogic> {
  const MelEditTablet({super.key});
                    ...
                    ? Padding(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            ), //controller.melEditViewTablet(),
                            MelEditView().editMelDataTabletViewReturn(controller),
                            const SizedBox(
                              height: SizeConstants.contentSpacing + 10,
                            ),
                            Row(
