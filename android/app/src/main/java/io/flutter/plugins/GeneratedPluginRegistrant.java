...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.devamitkumartiwari.device_safety_info.DeviceSafetyInfoPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin device_safety_info, com.devamitkumartiwari.device_safety_info.DeviceSafetyInfoPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.pranilshah.flutter_device_imei.FlutterDeviceImeiPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_device_imei, com.pranilshah.flutter_device_imei.FlutterDeviceImeiPlugin", e);
    }
    try {
