...
class FormsIndexMobilePortrait extends GetView<FormsIndexLogic> {
  const FormsIndexMobilePortrait({super.key});
...
class FormsIndexMobileLandscape extends GetView<FormsIndexLogic> {
  const FormsIndexMobileLandscape({super.key});
