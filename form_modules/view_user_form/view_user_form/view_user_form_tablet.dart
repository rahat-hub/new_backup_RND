...
class ViewUserFormTablet extends GetView<ViewUserFormLogic> {
  const ViewUserFormTablet({super.key});
                          ...
                          child: TabBar(
                            ...
                            isScrollable:
                                DeviceOrientation.isPortrait
                                    ? controller.myTabs.length <= 3
                                        ? false
                                        : true
                                    : controller.myTabs.length <= 4
                                    ? false
                                    : true,
        ...
        bottomNavigationBar: Obx(() {
          return controller.isLoading.isFalse
              ? Material(
                ...
                child: BottomAppBar(
                  child: Wrap(alignment: WrapAlignment.spaceAround, spacing: 20, children: ViewUserFormTopBottomLayers().bottomNavigationBarButtons(controller, context)),
                ),
              )
              : const SizedBox();
        }),
